// These are all the system defaults that are in config.h, that you really shouldn't change.
// I hated seeing them in my config.h, so they got moved here.

/* -------------------------------------------------------------------------- */
// non-system stuff i'll never use:
// =====================================
 ...
 * Note that if you want to use ShiftMask with selmasks, set this to an oth   er modifier, set to 0 to not use it. */
...
static Key key[] = {
    ...
    /* ------------------------------------------------------- */ 
	{ XK_KP_Delete,     XK_NO_MOD,      "\033[?1h\033=",      +1,    0,    0},
    /* ------------------------------------------------------- */ 
	...
	{ XK_Delete,        XK_NO_MOD,      "\033[?1h\033=",      +1,    0,    0},
    /* ------------------------------------------------------- */ 
